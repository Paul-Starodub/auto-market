...
def upgrade() -> None:
    ...
    sa.Column('fuel_type', sa.Enum('PETROL', 'DIESEL', 'ELECTRIC', 'GAS', 'HYBRID', name='fuel_type_enum'), nullable=True),
    sa.Column('transmission_type', sa.Enum('MANUAL', 'AUTOMATIC', 'TIPTRONIC', 'ROBOT', 'CVT', 'REDUCER', name='transmission_type_enum'), nullable=True),
    ...
    op.create_table('customers_cars',
    sa.Column('customer_id', sa.Integer(), nullable=False),
    sa.Column('car_id', sa.Integer(), nullable=False),
