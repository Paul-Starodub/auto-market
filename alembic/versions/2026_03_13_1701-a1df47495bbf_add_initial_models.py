...
Revision ID: a1df47495bbf
Revises:
Create Date: 2026-03-13 17:01:01.776133
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "car_type",
            sa.Enum("PASSENGER", "MOTO", "TRUCK", name="car_type_enum"),
            nullable=True,
        ),
        sa.Column(
            "fuel_type",
            sa.Enum(
                "PETROL", "DIESEL", "ELECTRIC", "GAS", "HYBRID", name="fuel_type_enum"
            ),
            nullable=True,
        ),
        sa.Column(
            ...
            sa.Enum(
                ...
                "CVT",
                "REDUCER",
                name="transmission_type_enum",
            ),
            nullable=True,
        ),
        sa.Column("start_year", sa.Date(), nullable=False),
        sa.Column("end_year", sa.Date(), nullable=False),
        sa.Column("costs", sa.DECIMAL(precision=15, scale=2), nullable=False),
    ...
    op.create_index(
        op.f("ix_car_images_car_id"), "car_images", ["car_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_customers_cars_id"), "customers_cars", ["id"], unique=False
    )
